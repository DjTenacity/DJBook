...
![img](https://images2015.cnblogs.com/blog/705728/201604/705728-20160424234824866-481636745.png)
...
链路数据层可以这么举例子。
首先，网络层是确定传输位置美也就是确定集散中心传输路线，保证路线畅通无阻可达。
然后，数据链路层就是准备发送前，需要装箱分类检查，去往广东的放在一块，检测是否有违禁品。